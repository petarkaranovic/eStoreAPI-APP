            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    <div>
                        ...
                        <div v-if="isLoggedIn">
                            <div class="row">
                                <label for="adress" class="col-md-3 col-form-label">Delivery adress</label>
                                <div class="col-md-9">
                                    <input id="adress" type="text" class="form-control" v-model="adress" required>
                                </div>
                            </div>
                            <br>
...
export default {
    ...
    methods:{
        ...
        placeOrder(e){
            ...
            axios.post('api/orders/', {adress,quantity,product_id})
