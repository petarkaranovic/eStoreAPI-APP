            ...
            <table class="table table-responsive table-striped">
                ...
                <tbody>
                    <tr v-for="(product,index) in products" :key="index" @dblclick="editingItem = product">
                        ...
                        <td> <input type="text" v-model="product.units">{{product.units}}</td>
                        <td> <input v-model="product.price">{{product.price}}</td>
                        <td> <input v-model="product.price">{{product.description}}</td>
                    </tr>
                </tbody>
            </table>
...
export default {
    ...
    methods:{
        ...
        endEditing(product){
            ...
            axios.put(`/api/products/${product.id}`, {name,units,price,image,description})
